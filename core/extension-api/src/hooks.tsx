...
const MSG = (name: string): string =>
  `@vibe-ctl/extension-api: ${name}() must be called inside a vibe-ctl plugin host. The runtime injects real implementations; the published package only ships stubs.`;
