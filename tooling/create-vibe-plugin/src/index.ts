/**
 * create-vibe-plugin — CLI entry.
 *
 * Usage:
 *   npx create-vibe-plugin [plugin-name] [--yes]
 *
 * Flow:
...
function printHelp(): void {
  console.log(`
${kleur.bold('create-vibe-plugin')} — scaffold a new vibe-ctl plugin.

${kleur.bold('Usage')}
  npx create-vibe-plugin ${kleur.dim('[plugin-name]')} ${kleur.dim('[--yes]')}
